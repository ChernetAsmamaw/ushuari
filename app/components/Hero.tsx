...
import { ArrowRight, Mic, Shield, Scale } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 py-24 flex flex-col items-center text-center space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/sign-up">
              <button className="px-8 py-4 bg-[#D4AF37] hover:bg-[#C09A27] text-[#002366] font-bold rounded-lg flex items-center space-x-2 transition-all">
          ...
          <div className="relative max-w-sm w-full h-32 md:h-36 bg-gradient-to-r from-[#001A4D]/80 to-[#002366]/80 backdrop-blur-sm p-4 rounded-2xl border border-white/20 flex items-center justify-center">
      ...
      <section className="py-20 bg-white/5 backdrop-blur-sm">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-gradient-to-b from-[#001A4D] to-[#002366] p-8 rounded-xl border border-white/10 shadow-xl hover:shadow-2xl hover:border-[#D4AF37]/30 transition-all group">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link href="/auth/sign-up">
              <button className="px-8 py-4 bg-[#D4AF37] hover:bg-[#C09A27] text-[#002366] font-bold rounded-lg flex items-center space-x-2 mx-auto">
